...
export default function HomeIntro() {
  return (
    <div className="min-h-screen overflow-hidden px-4 relative py-11 flex flex-col items-center justify-center ">
        <h1 className="font-bold text-3xl mb-4 lg:font-black lg:text-6xl text-center max-w-screen-sm mx-auto">Skills speak louder than words</h1>
        ...
        <p className="text-sm mb-8">Over 40% of developers worldwide and 3,000 companies use HackerRank</p>
        <LogoStrip/>
