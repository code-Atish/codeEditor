				...
				<div className="flex flex-col  gap-10 lg:gap-20 lg:flex-row items-center justify-between bg-white p-8">
					<div className="">
						...
						<p className=" text-lg text-gray-600 mt-4">
							...
							countries around the world, trust Upto Skills to connect with
					...
					<div className="mt-8 md:mt-0 bg-gray-50 p-8  w-full lg:max-w-sm">
						<div className="text-center">
							<img
								src="/path/to/vmware-logo.png"
								alt="VMware Logo"
								className="mx-auto mb-4"
							/>
							<p className="text-lg text-gray-700">
								“Upto Skills has actually allowed us to look for diamonds in the
								rough that our old process didn’t give us the time or resources
								to look for.”
							</p>
