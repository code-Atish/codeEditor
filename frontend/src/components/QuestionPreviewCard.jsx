...
const QuestionPreviewCard = ({
	...
	return (
		<div
			className="m-4 px-10 py-5 m-auto bg-white dark:bg-gray-900 rounded-lg flex item-center justify-between flex-wrap w-[60vw]"
			style={{ maxWidth: "95%" }}
		>
			...
			<div className="">
				...
				<button className="py-1 px-3 mt-3 ml-5 border border-gray-500 inline-block rounded text-black dark:text-white ">
					Solve challange
				</button>
			</div>
		</div>
