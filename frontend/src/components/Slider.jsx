...
const ImageSlider = () => {
	...
	return (
		<div className="relative w-full mb-20 pb-[49%] overflow-hidden">
			<figure
				className="absolute w-full h-full bg-cover m-0"
				style={{ backgroundImage: "url(report-2.jpg)" }}
			>
				<div
					ref={shade1Ref}
				...
				>
					...
					></div>
					<div
						className="absolute top-0 right-[-1px] w-[2px]  bg-black z-[3] shadow-[0_-3px_8px_2px_rgba(0,0,0,0.3)]"
						style={{ height: "calc(50% - 15px)" }}
					></div>
					<div
						className="absolute bottom-0 right-[-1px] w-[2px]  bg-black z-[3] shadow-[0_3px_8px_2px_rgba(0,0,0,0.3)]"
						style={{ height: "calc(50% - 15px)" }}
					></div>
				</div>
			</figure>
			<input
				...
				style={{ width: "calc(100% + 34px)", left: "-18px" }}
			/>
		</div>
	);
};
...
//       <figure className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://www.uptoskills.com/wp-content/uploads/2022/09/report-2.jpg')" }}>
...
//           </svg>
//         </div>
//         <div ref={divisorRef} className="absolute inset-0 bg-cover bg-center shadow-md" style={{ backgroundImage: "url('https://www.uptoskills.com/wp-content/uploads/2022/09/resume.jpg')", width: '0%' }}>
